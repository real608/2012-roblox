...
Roblox.VideoPreRoll = {
    ...
    checkEligibility: function checkEligibility() {
        if (Roblox.VideoPreRoll.showVideoPreRoll) {
            if (!flashCheck(8)) { // flash not installed
...
/*
     ...
     INTERNET ARCHIVE ON 03:45:43 Jul 24, 2020.
...
playback timings (ms):
  ...
  RedisCDXSource: 28.667
  exclusion.robots.policy: 0.361
  CDXLines.iter: 31.634 (3)
  captures_list: 292.305
  load_resource: 174.89
  esindex: 0.016
  LoadShardBlock: 227.166 (3)
  PetaboxLoader3.datanode: 316.022 (4)
  PetaboxLoader3.resolve: 54.423
*/